...
//
export function loadTexture(gl, url, renderType) {
  ...
  image.onload = function () {
    ...
    if (isPowerOf2(image.width) && isPowerOf2(image.height)) {
      ...
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, renderType);
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, renderType);
    }
  };
  image.crossOrigin = "";
  image.src = url;
